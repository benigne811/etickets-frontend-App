...
import { Plus, Search, Mail, Phone, ChevronLeft, ChevronRight, Edit, Trash2, Users } from "lucide-react";
...
export function EmployeesPage({ employees, onAddClick, onEditClick, onDeleteClick }: EmployeesPageProps) {
      ...
      {employees.length === 0 ? (
        <div className="bg-card border border-border rounded-xl shadow-sm">
          <EmptyState
            ...
            description="Get started by adding your first employee to the system. They will be able to handle customer support tickets."
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow key={employee.id} className="hover:bg-muted/50">
                ...
                <TableCell>
                  <span className="font-medium">{employee.assignedTickets}</span>
                </TableCell>
