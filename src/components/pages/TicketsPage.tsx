...
export function TicketsPage({ tickets, employees, customers, onTicketClick, onAssignTicket, onCreateTicketClick }: TicketsPageProps) {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button onClick={onCreateTicketClick} className="self-start sm:self-auto">
        ...
        <div className="bg-card border border-border rounded-xl shadow-sm">
          <EmptyState
            ...
            description={customers.length === 0 
              ? "You need to add customers first before creating tickets. Navigate to the Customers page to get started."
              : "No support tickets have been created yet. Click the button above to create your first ticket."}
            actionLabel={customers.length === 0 ? undefined : "Create First Ticket"}
            onAction={customers.length === 0 ? undefined : onCreateTicketClick}
          />
        </div>
      ) : (
